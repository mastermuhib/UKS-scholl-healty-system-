            ...
            <div class="col-lg-3">
                <div style="margin-bottom: 30px">
                    ...
                    <div class="bg-white text-center rounded-xl">
                        <div class="p-3">
                            <h3 class="font-weight-bold">{{ number_format($bisnis_aktif) }}</h3>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div style="margin-bottom: 30px">
                    ...
                    <div class="bg-white text-center rounded-xl">
                        <div class="p-3">
                            <h3 class="font-weight-bold">{{ number_format($bisnis_aktif_bulan) }}</h3>
                            <a href="#" class="text-dark-75 font-weight-bold font-size-h6">Pendaftar</a>
                        </div>
                    </div>
                </div>
         ...
         <div class="row">
            <div class="col-lg-3">
                <div style="margin-bottom: 30px">
                    ...
                    <div class="bg-white text-center rounded-xl">
                        <div class="p-3">
                            <h3 class="font-weight-bold">{{ number_format($bisnis_aktif_hari) }}</h3>
                            <a href="#" class="text-dark-75 font-weight-bold font-size-h6">Pendaftar</a>
                        </div>
                    </div>
                </div>
