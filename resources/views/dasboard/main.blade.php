            ...
            <div class="col-xl-2 col-sm-6 col-xs-6">
                ...
                <div class="card card-custom bg-info card-stretch gutter-b" style="background-color: #3F99F7 !important;">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-white-red font-size-sm">Konversi</span>
                        <p class="font-weight-bold text-white-red">{{$persen_member_aktif}}</p>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 30-->
                        ...
                        <div class="card-spacer mt-2">
                            ...
                            <div class="row m-0">
                                <div class="col bg-white px-6 py-8 rounded-xl mr-7 mb-7 text-center">
                                    ...
                                    <a href="#" class="text-dark font-weight-bold font-size-h6 mt-2">{{number_format($bisnis_aktif)}}</a>
                                    <br>
                                    <span class="font-weight-bold text-dark font-size-sm">Bisnis Aktif</span>
                                </div>
