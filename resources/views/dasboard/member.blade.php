        ...
        <div class="row mb-3">
            ...
            <div class="col-xl-2 col-sm-6 col-xs-6">
                ...
                <div class="card card-custom bg-info card-stretch gutter-b" style="background-color: #3F99F7 !important;">
                    <!--begin::Body-->
                    <div class="card-body">
                        <a href="#" class="card-title font-weight-bolder text-white-red font-size-h6 mb-4 text-hover-state-dark d-block">Aktif</a>
                        <span class="card-title font-weight-bolder text-white-red font-size-h2 mb-0 mt-6 d-block">{{number_format($member_aktif)}}</span>
                        <span class="text-white-red font-size-sm">Konversi</span>
                        <p class="text-white-red font-weight-bold">{{$persen_member_aktif}}</p>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 30-->
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-sm-6 col-xs-6">
                ...
                <div class="card card-custom bg-info card-stretch gutter-b" style="background-color: #60A7F1 !important;">
                    ...
                    <div class="card-body">
                        <a href="#" class="card-title font-weight-bolder text-white-red font-size-h6 mb-4 text-hover-state-dark d-block">Aktif</a>
                        <span class="card-title font-weight-bolder text-white-red font-size-h2 mb-0 mt-6 d-block">{{number_format($member_aktif_bulan)}}</span>
                        <span class="text-white-red font-size-sm">Konversi</span>
                        <p class="text-white-red font-weight-bold">{{$persen_member_aktif_bulan}}</p>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 30-->
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-sm-6 col-xs-6">
                ...
                <div class="card card-custom bg-info card-stretch gutter-b" style="background-color: #76B5F8 !important;">
                    ...
                    <div class="card-body">
                        <a href="#" class="card-title font-weight-bolder text-white-red font-size-h6 mb-4 text-hover-state-dark d-block">Aktif</a>
                        <span class="card-title font-weight-bolder text-white-red font-size-h2 mb-0 mt-6 d-block">{{number_format($member_aktif_hari)}}</span>
                        <span class="text-white-red font-size-sm">Konversi</span>
                        <p class="text-white-red font-weight-bold">{{$persen_member_aktif_hari}}</p>
                    </div>
                    <!--end::Body-->
                </div>
                <!--end::Stats Widget 30-->
