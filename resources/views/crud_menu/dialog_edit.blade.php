                        ...
                        <form class="form-horizontal p-3" novalidate id="form_edit">
                            ...
                            <div class="form-row mb-5">
                                ...
                                <div class="form-group col-md-6 urutan-menu" <?php if( $data->parent_menu_id != 0 ) { echo "style='display: none'"; } ?> >
                                    ...
                                    <input type="number" min="1" max="{{ $max_serial_menu }}" name="serial_menu" id="urutan-menu" class="form-control form-control-lg" value="{{ $data->no_urut }}">
                                    <input type="hidden" name="old_serial_menu" value="{{ $data->no_urut }}">
                                </div>
                                <div class="form-group col-md-6 urutan-sub-menu" <?php if( $data->parent_menu_id == 0 ) { echo "style='display: none'"; } ?> >
                                    ...
                                    <input type="number" min="1" max="{{ $max_serial_sub_menu }}" name="serial_sub_menu" value="{{ $data->no_urut }}" class="form-control form-control-lg urutan-sub">
                                    <input type="hidden" name="old_serial_sub" value="{{ $data->no_urut }}">
